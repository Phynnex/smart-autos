    ...
    <>
      <section className="flex justify-between">
        ...
        <div>
          ...
          <h5 className="text-2xl font-medium pb-2 pt-4">Charge what you want</h5>
          <div>
            <div className="flex">
              <CheckCircleIcon />
              <p className="pl-4 text-lg pb-2">
            ...
            <h5 className="text-2xl font-medium pb-2 pt-4">Commissions</h5>
            <div className="flex">
              <CheckCircleIcon />
              <p className="pl-4 text-lg pb-2">
            ...
            <h5 className="text-2xl font-medium pb-2 pt-4">
              Get paid after every Successful transaction
            </h5>
            <div className="flex">
              <CheckCircleIcon />
              <p className="pl-4 text-lg pb-2">
